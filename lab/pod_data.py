...
def get_lab_data():
    ...
    data= {
        "cl_id":                    "LTRACI-2967",
        "cl_title":                 "ACI with Kubernetes to create a private devops cloud",
        "cl_abstract":              abstract,
        "cl_lab_proctors":          ["Rafael Muller","Luis Flores","Cesar Obediente"],
        "cl_lab_proctor_emails":    ["rmuller@cisco.com", "luflores@cisco.com", "co@cisco.com"],
        "cl_lab_proctor_titles":    ["Principal Engineer, Services", "System Engineer, Sales", "Principal Engineer, Sales"],
    }
    return data
